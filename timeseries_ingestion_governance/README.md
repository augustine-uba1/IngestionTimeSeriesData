# timeseries_ingestion_governance

The 'timeseries_ingestion_governance' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] timeseries_ingestion_governance_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/timeseries_ingestion_governance.job.yml). The schedule
